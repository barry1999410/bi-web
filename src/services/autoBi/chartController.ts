...
/** genChatByAi POST /api/chart/gen */
export async function genChatByAiUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChatByAiUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
/** genChatByAiAsync POST /api/chart/gen/async */
export async function genChatByAiAsyncUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChatByAiAsyncUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
/** genChatByAiAsyncMq POST /api/chart/gen/async/mq */
export async function genChatByAiAsyncMqUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChatByAiAsyncMqUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
